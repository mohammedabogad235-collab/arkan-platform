      ...
      <div className="prose prose-lg max-w-none space-y-8 text-foreground">
        ...
        <section className="bg-card rounded-2xl p-6 border shadow-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">
            باستخدامك لـ Arkan وخدماتها، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي من هذه الشروط، فيرجى عدم استخدام خدماتنا. نحتفظ بالحق في تعديل هذه الشروط في أي وقت، وسيتم إخطارك بأي تغييرات جوهرية.
          </p>
        </section>
