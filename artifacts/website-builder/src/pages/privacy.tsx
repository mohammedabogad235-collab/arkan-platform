      ...
      <div className="prose prose-lg max-w-none space-y-8 text-foreground">
        ...
        <section className="bg-card rounded-2xl p-6 border shadow-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">
            نحن في Arkan نأخذ خصوصية مستخدمينا على محمل الجد. توضح هذه السياسة كيفية جمع بياناتك الشخصية واستخدامها وحمايتها. باستخدامك لخدماتنا، فإنك توافق على ممارسات جمع البيانات المبينة في هذه السياسة.
          </p>
        </section>
